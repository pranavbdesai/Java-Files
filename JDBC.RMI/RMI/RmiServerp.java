...
public class RmiServerp extends java.rmi.server.UnicastRemoteObject implements ReceiveMessageInterfacep 
{
...
public void Tally() throws Exception
	{
if(s.equals("tally")==true ||s.equals("Tally")==true || s.equals("TALLY")==true)
	{
		p=r.exec("freecell");
	}
	
	}
    public RmiServerp() throws RemoteException
    {
        try{
